...
const DARK = {
  bg:          "#04060C",
  surface:     "rgba(15,57,51,0.28)",
  surfaceH:    "rgba(15,57,51,0.46)",
  border:      "rgba(151,252,228,0.13)",
  borderH:     "rgba(151,252,228,0.28)",
  text1:       "#F5FEFD",
  text2:       "#c6ddd8",
  text3:       "#98b6ae",
  text4:       "#79958e",
  ...
  overlay12:   "rgba(151,252,228,0.13)",
  overlay15:   "rgba(255,255,255,0.15)",
  overlay20:   "rgba(151,252,228,0.28)",
  ...
  glassBg:     "linear-gradient(135deg, rgba(15,57,51,0.36), rgba(15,57,51,0.10))",
  glassInset:  "inset 0 1px 0 rgba(255,255,255,0.04)",
  glassShadow: "0 2px 12px rgba(0,0,0,0.3)",
  headerBg:    "linear-gradient(180deg, rgba(15,57,51,0.65) 0%, rgba(4,6,12,0.94) 100%)",
  popoverBg:   "linear-gradient(180deg, rgba(12,35,32,0.98), rgba(4,6,12,0.98))",
  drawerBg:    "linear-gradient(180deg, rgba(10,30,28,0.97) 0%, rgba(4,6,12,0.98) 100%)",
  selectBg:    "#0b211f",
  scrollThumb: "rgba(151,252,228,0.13)",
  scrollHover: "rgba(255,255,255,0.25)",
  // Chart-specific (resolved values for canvas/libraries)
  chartGrid:   "rgba(255,255,255,0.03)",
  chartCross:  "rgba(151,252,228,0.3)",
  chartLabel:  "#1a1a1a",
  chartText:   "#98b6ae",
};
