...
export default function NavDrawer({ isOpen, onClose, activeTab, onTabChange, isMobile, groups, activeGroupId, onGroupChange, onGroupCreate, onGroupEdit }) {
            ...
            {groups.map(g => {
              ...
              return (
                <div key={g.id} style={{ display: "flex", alignItems: "center", gap: 4, marginBottom: 2 }}>
                  <button
                    onClick={() => { onGroupChange?.(g.id); onClose(); }}
                    style={{
                  ...
                  return (
                    ...
                    >
                      <div style={{ minWidth: 0 }}>
                        <div style={{
                          fontFamily: T.font, fontSize: 14, fontWeight: isActive ? 600 : 500,
                        ...
                        <div style={{
                          fontFamily: T.font, fontSize: 12, color: T.text4,
                          marginTop: 1,
                        }}>
                          {item.desc}
                        </div>
